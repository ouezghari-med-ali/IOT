        ...
        if serial.is_valid():
            ...
            if serial.is_valid():
                ...
                if derniere_temperature > 25:
                    ...
                    recipient_list = ['aliouez181@gmail.com']
                    send_mail(subject, message, email_from, recipient_list)

                    # Alert WhatsApp
                    account_sid = 'AC55ee0e036aa0a1ce37d30be268fb0ac2'
                    auth_token = '14db03012d3728d6aa19e572ed98a10a'
                    ...
                    message_whatsapp = client.messages.create(
                        from_='whatsapp:+14155238886',
                        body='La température dépasse le seuil de 25°C, veuillez intervenir immédiatement pour vérifier et corriger cette situation',
                        to='whatsapp:+212653644108'
                    )
                    # Alert Telegram
                    telegram_token = '77490289359:AAHaMiaozL8frKh5V7ZwchOUZV2m5rfCTc4'
                    chat_id = '6144256458'  # Remplacez par votre ID de chat
